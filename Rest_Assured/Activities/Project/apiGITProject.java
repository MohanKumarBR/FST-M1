...
public class apiGITProject {
    // SSH Key to test with
    String sshKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKM8UXfSAE2cJ9e6So8YoKrGzw3vLFyp3T39i/muJJXS";
    ...
    public void setUp() {
    	...
    	requestSpec = new RequestSpecBuilder().
			...
			addHeader("Authorization", "Bearer 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").
